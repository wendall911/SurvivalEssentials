...
public class ModItemTagsProvider extends ItemTagsProvider {
    ...
    public ModItemTagsProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider, CompletableFuture<TagLookup<Block>> blockTagsProvider) {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(TagManager.Items.SHEAR_TOOLS)
            .addTag(TagManager.Items.FORGE_SHEAR_TOOLS)
            .addTag(TagManager.Items.CONVENTIONAL_SHEAR_TOOLS);
        ...
        this.tag(TagManager.Items.STRING)
            .addTag(TagManager.Items.FORGE_STRING)
            .addTag(TagManager.Items.CONVENTIONAL_STRING);
