...
public final class TagManager {
    ...
    public static final class Items {
        ...
        public static final TagKey<Item> STRING = create("string");

        // Adding both Conventional AND Forge tags for 1.20.4 TODO: Removed Forge tags in 1.20.6+
        public static final TagKey<Item> FORGE_SHEAR_TOOLS = forgeTag("shears");
        public static final TagKey<Item> CONVENTIONAL_SHEAR_TOOLS = conventionalTag("shears");
        public static final TagKey<Item> FORGE_STRING = forgeTag("string");
        public static final TagKey<Item> CONVENTIONAL_STRING = conventionalTag("string");
        ...
        // Ars Nouveau
        public static TagKey<Item> ARS_ARCHWOOD = forgeTag("logs/archwood");
        ...
        private static TagKey<Item> conventionalTag(String name) {
            return TagKey.create(Registries.ITEM, conventionalLoc(name));
        }
    ...
    public static final class Blocks {
        ...
        // Adding both Conventional AND Forge tags for 1.20.4 TODO: Removed Forge tags in 1.20.6+
        public static final TagKey<Block> FORGE_GRAVEL = forgeTag("gravel");
        public static final TagKey<Block> CONVENTIONAL_GRAVEL = conventionalTag("gravel");
        public static final TagKey<Block> FORGE_SAND = forgeTag("sand");
        public static final TagKey<Block> CONVENTIONAL_SAND = conventionalTag("sand");
        public static final TagKey<Block> FORGE_ORES_COAL = forgeTag("ores/coal");
        public static final TagKey<Block> CONVENTIONAL_ORES_COAL = conventionalTag("ores/coal");
        public static final TagKey<Block> FORGE_ORES_IRON = forgeTag("ores/iron");
        public static final TagKey<Block> CONVENTIONAL_ORES_IRON = conventionalTag("ores/iron");
        public static final TagKey<Block> FORGE_ORES_COPPER = forgeTag("ores/copper");
        public static final TagKey<Block> CONVENTIONAL_ORES_COPPER = conventionalTag("ores/copper");
        ...
        private static TagKey<Block> conventionalTag(String name) {
            return TagKey.create(Registries.BLOCK, conventionalLoc(name));
        }
    }
    ...
    public static ResourceLocation conventionalLoc(String path) {
